...
Push the groups button and then the PLSU button
...
Push the groups button and in the emergent window select managedhosts group previosly created, then press save
...
Follow the steps depicted in the following inages.
...
When we lanuch the template, a job is created and automatically redirected to its information screen where the progress screen could be observed to understand how the playbook is being executed.
