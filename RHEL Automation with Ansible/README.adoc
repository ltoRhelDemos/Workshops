...
If you go with this option you will have to use the server as control host and managed host. This server have *ansible* already installed so you can skip the installation steps described in this document.
