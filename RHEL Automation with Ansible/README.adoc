...
For installing the application that is part of the goal of this lab you will have to creato two loop devices as desscriobed https://github.com/ltoRhelDemos/Workshops/blob/master/RHEL%20Automation%20with%20Ansible/loopbackDevices.adoc[here], before start the exercises.
